...
const agt_extended_cfg_t g_timer2_extend =
...
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x8000,
  .duty_cycle_counts = 0x4000, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = R_AGT1_interrupt,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .p_ctrl = &g_timer2_ctrl, .p_cfg = &g_timer2_cfg, .p_api = &g_timer_on_agt };
...
/* Actual period: 0.0999755859375 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xccc,
  .duty_cycle_counts = 0x666, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = R_AGT0_interrupt,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
