...
#include "hal_data.h"
#include "C:\Users\Sejeong\ra6m3_ws\Renesas_SummerCamp_CAN_Ex1\AppWizard\Source\CustomCode\Application.h"
#include "C:\Users\Sejeong\ra6m3_ws\Renesas_SummerCamp_CAN_Ex1\AppWizard\Source\Generated\Resource.h"
#include "C:\Users\Sejeong\ra6m3_ws\Renesas_SummerCamp_CAN_Ex1\AppWizard\Source\Generated\ID_SCREEN_00.h"
    ...
    if(Rx_SERIAL_DATA[2] == 'A' ) //CAN ID and MSG transmission
    {
        ...
        switch(p_args->data)
        {
            case'>':
                ...
                /*           LCD Write          */
                for(int x = 0; x < 9; x++) CAN_Buffer_t[x] = 0;
